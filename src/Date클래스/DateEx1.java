...
// Date 클래스 : 1970년 1월 1일 0시 0분 0초부터 msec 단위로 경과 시간을 운영체제로부터 얻어낸다.
// SimpleDateFormat 클래스 : 얻은 시간 정보를 원하는 날짜와 시간 형태로 변환하여 출력하는 포맷
public class DateEx1 {
    public static void main(String[] args) {
        Date now = new Date(); // Date 클래스로 객체를 생성 후 사용해야 한다.
        // yyyy : 년도를 4자리로 표현(2023)
        // yy : 년도를 2자리로 표현(23)
        // MM : 월을 표시(월이 한 자리일 경우 앞에 0을 포함, 반드시 M은 대문자)
        // mm : 분을 표시(분이 한 자리일 경우 앞에 0을 포함, 반드시 m으로 표기)
        // HH : 24시간제 표시
        // hh : 12시간제 표시
        // W : 월에서 몇 주차인지 표시
        // w : 년에서 몇 주차인지 표시
