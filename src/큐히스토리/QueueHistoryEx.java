...
public class QueueHistoryEx {
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            if(cmd.equalsIgnoreCase("q")) { // 대소문자 상관없이 q 입력 시 종료
    ...
    void save(String cmd) {
        queue.offer(cmd);
        if(queue.size() > MAX_SIZE) queue.remove(); // Queue 의 맨 앞의 요소를 제거
    }
}
