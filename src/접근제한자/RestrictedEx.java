...
// 접근제한자 : 객체지향 4가지 특성 중 하나이며, 데이터 은닉 또는 캡슐화의 핵심 개념
// 데이터은닉 : 사용자가 알 필요가 없거나 숨겨야 할 정보를 보이지 않도록 하는 것.
// 대형 프로젝트 진행 중 필드 값을 외부에 접근 가능한 경우 여러가지 문제점이 발생 할 수 있다.
...
class ChildRest extends ParentRest {
    ...
    public String getMoney() {  // protected 에 대한 접근 (동일 패키지와 상속 관계가 성립하면 접근 허용)
        return money;
    }
